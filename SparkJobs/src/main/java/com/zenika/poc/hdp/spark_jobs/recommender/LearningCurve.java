...
public class LearningCurve {
     ...
     * @throws Exception
     * 
     * sudo spark-submit --class com.zenika.poc.hdp.spark_jobs.recommender.LearningCurve poc.hdp-1.0-SNAPSHOT.jar "hdfs://sandbox.hortonworks.com:8020/poc/data/movielens_1m/ratings.dat" "::" "4" "hdfs://sandbox.hortonworks.com:8020/poc/curve1m"
     */
