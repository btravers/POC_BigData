...
public class LearningCurve {
     ...
     * @throws Exception
     * 
     * $SPARK_HOME/bin/spark-submit --class com.zenika.poc.hdp.spark_jobs.recommender.LearningCurve /spark_jobs-1.0-SNAPSHOT-jar-with-dependencies.jar file:/data/ratings.dat :: 4 file:/data/curve1m
     */
